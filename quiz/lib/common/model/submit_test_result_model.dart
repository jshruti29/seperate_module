...
SubmitTestResultModel submitTestResultModelFromJson(String str) => SubmitTestResultModel.fromJson(json.decode(str));

String submitTestResultModelToJson(SubmitTestResultModel data) => json.encode(data.toJson());

class SubmitTestResultModel {
  SubmitTestResultModel({
    this.ques,
    this.percentage,
    this.totCorrect,
    this.totIncorrect,
  ...
  dynamic percentage;
  dynamic totCorrect;
  dynamic totIncorrect;
  dynamic notAttempt;
  dynamic markObtain;
  dynamic flag;
  dynamic authFlag;

  factory SubmitTestResultModel.fromJson(Map<String, dynamic> json) => SubmitTestResultModel(
